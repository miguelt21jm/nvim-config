...
local keymaps = {
    ...
    { key = "<leader>fw", cmd = "live_grep",            desc = "Live grep" },
    ...
    { key = "<leader>fg", cmd = "current_buffer_fuzzy_find",              desc = "Fuzzy find current buffer" },

    { key = "<leader>fh", cmd = "help_tags",            desc = "Help tags" },
    { key = "<leader>fs", cmd = "lsp_document_symbols", desc = "Document symbols" },
    { key = "gr",         cmd = "lsp_references",       desc = "References" },
    { key = "gi",         cmd = "lsp_implementations",  desc = "References" },
    { key = "gd",         cmd = "lsp_definitions",      desc = "References" },
}
